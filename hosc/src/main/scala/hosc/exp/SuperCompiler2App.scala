...
object SuperCompilerApp2 {
  val help = """usage: hosc.SuperCompilerApp2 -si sinput_file -t tree_output_file -p program_output_file
  |Where:
  ...
  def main(args : Array[String]) : Unit = {
    ...
    val sc = new SuperCompiler2(program)
