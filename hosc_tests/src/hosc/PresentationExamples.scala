...
class PresentationExamples {
  ...
  @Test def example04_2append(): Unit = {    
    SuperCompiler0App.main(Array("-si", "pres/in/04a_2append.hl0", "-t", "pres/out/04a_2append.svg", "-p", "pres/out/04a_2append.hl1"));
    SuperCompiler0App.main(Array("-si", "pres/in/04b_2append.hl0", "-t", "pres/out/04b_2append.svg", "-p", "pres/out/04b_2append.hl1"));
  }
